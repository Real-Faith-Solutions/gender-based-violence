...
class CreateUserRoleUsersActivityLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_role_users_activity_logs', function (Blueprint $table) {
            $table->id();
            $table->string('subject_role_name')->nullable();
    ...
    {
        Schema::dropIfExists('user_role_users_activity_logs');
    }
}
