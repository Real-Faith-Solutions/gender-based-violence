    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6" style="display: flex; align-items: center;">
            <h1 class="text-gray-800">Directories</h1>
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ env('APP_URL') }}admin/maintenance/directory-type">Directory Type</a></li>
      ...
      <div class="card-body table-responsive">
        ...
        @csrf
          <div class="input-group">
            <input type="text" name="directory_last_name_search" id="directory_last_name_search" class="form-control bg-light border-0 small" placeholder="Enter Last Name" aria-label="Search" aria-describedby="basic-addon2">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card shadow">
            <div class="card-header">
              <span class="card-title h6 font-weight-bold text-primary">Directories Table</span>
            </div>
            <div class="card-body table-responsive">
