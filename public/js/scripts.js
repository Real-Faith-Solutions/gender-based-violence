...
if ($("#case_no").val() && location.href.includes("edit-created-case")) {
    // If Encoded and Edit page
    ...
    $.ajax({
        ...
        success: function (case_status) {
            if (case_status == "Closed") {
                ...
                $('* [value="Add Multiple Intervention"]').attr(
                    "hidden",
                    "hidden"
                );
                ...
                $(
                    '[onclick^="deleteSpecificAdditionalFamilyBackgroundModal"]'
                ).removeAttr("onclick");
                $(
                    '[onclick^="deleteSpecificAdditionalIncidenceDetailsModal"]'
                ).removeAttr("onclick");
                $(
                    '[onclick^="deleteSpecificAdditionalPerpetratorDetailsModal"]'
                ).removeAttr("onclick");
                $(
                    '[onclick^="deleteSpecificAdditionalInterventionModuleModal"]'
                ).removeAttr("onclick");
                $('[onclick^="deleteCaseUploadedFilesModal"]').removeAttr(
                    "onclick"
                );

                // removed onclick closed modal function on additional record
                $(
                    '[onclick^="closeAdditionalFamilyBackgroundForm"]'
                ).removeAttr("onclick");
                $(
                    '[onclick^="closeAdditionalIncidenceDetailsForm"]'
                ).removeAttr("onclick");
                $(
                    '[onclick^="closeAdditionalPerpetratorDetailsForm"]'
                ).removeAttr("onclick");
                $(
                    '[onclick^="closeAdditionalInterventionModuleForm"]'
                ).removeAttr("onclick");
...
$(document).ready(function () {
    ...
    $("#case_no").on("change", function () {
        ...
        $.ajax({
            url:
                rootURL + "api/v1/case/validate-case-no/" + $("#case_no").val(),
...
$("#fam_back_province").change(function () {
    $("#fam_back_province_id").val(
        $("#fam_back_province option:selected").text()
    );
});
...
$("#fam_back_barangay").change(function () {
    $("#fam_back_barangay_id").val(
        $("#fam_back_barangay option:selected").text()
    );
});
...
$("#inci_det_province").change(function () {
    $("#inci_det_province_id").val(
        $("#inci_det_province option:selected").text()
    );
});
...
$("#inci_det_barangay").change(function () {
    $("#inci_det_barangay_id").val(
        $("#inci_det_barangay option:selected").text()
    );
});
...
$("#user_municipality").change(function () {
    $("#user_municipality_id").val(
        $("#user_municipality option:selected").text()
    );
});
...
$("#fam_back_region_modal").change(function () {
    $("#fam_back_region_modal_id").val(
        $("#fam_back_region_modal option:selected").text()
    );
});
$("#fam_back_province_modal").change(function () {
    $("#fam_back_province_modal_id").val(
        $("#fam_back_province_modal option:selected").text()
    );
});
$("#fam_back_city_modal").change(function () {
    $("#fam_back_city_modal_id").val(
        $("#fam_back_city_modal option:selected").text()
    );
});
$("#fam_back_barangay_modal").change(function () {
    $("#fam_back_barangay_modal_id").val(
        $("#fam_back_barangay_modal option:selected").text()
    );
});
...
$("#inci_det_region_modal").change(function () {
    $("#inci_det_region_modal_id").val(
        $("#inci_det_region_modal option:selected").text()
    );
});
$("#inci_det_province_modal").change(function () {
    $("#inci_det_province_modal_id").val(
        $("#inci_det_province_modal option:selected").text()
    );
});
$("#inci_det_city_modal").change(function () {
    $("#inci_det_city_modal_id").val(
        $("#inci_det_city_modal option:selected").text()
    );
});
$("#inci_det_barangay_modal").change(function () {
    $("#inci_det_barangay_modal_id").val(
        $("#inci_det_barangay_modal option:selected").text()
    );
});
...
$("#perp_d_region_modal").change(function () {
    $("#perp_d_region_modal_id").val(
        $("#perp_d_region_modal option:selected").text()
    );
});
$("#perp_d_province_modal").change(function () {
    $("#perp_d_province_modal_id").val(
        $("#perp_d_province_modal option:selected").text()
    );
});
$("#perp_d_city_modal").change(function () {
    $("#perp_d_city_modal_id").val(
        $("#perp_d_city_modal option:selected").text()
    );
});
$("#perp_d_barangay_modal").change(function () {
    $("#perp_d_barangay_modal_id").val(
        $("#perp_d_barangay_modal option:selected").text()
    );
});

// Start of change address on edit Case confirmation

function changeAddressOnEditCase(
    select_tag_region_id,
    select_tag_province_id,
    select_tag_city_id,
    select_tag_barangay_id
) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            var my_handlers = {
                ...
                fill_provinces: function () {
                    var region_code = $(this).val();
                    $("#" + select_tag_province_id + "").ph_locations(
                        "fetch_list",
                ...
                fill_cities: function () {
                    var province_code = $(this).val();
                    $("#" + select_tag_city_id + "").ph_locations(
                        "fetch_list",
                ...
                fill_barangays: function () {
                    var city_code = $(this).val();
                    $("#" + select_tag_barangay_id + "").ph_locations(
                        "fetch_list",
                        [{ city_code: city_code }]
                    );
                },
            ...
            $(function () {
                // Personal Details
                $("#" + select_tag_region_id + "").on(
                    "change",
                    my_handlers.fill_provinces
                );
                $("#" + select_tag_province_id + "").on(
                    "change",
                    my_handlers.fill_cities
                );
                $("#" + select_tag_city_id + "").on(
                    "change",
                    my_handlers.fill_barangays
                );

                $("#" + select_tag_region_id + "").ph_locations({
                ...
                $("#" + select_tag_region_id + "").on("click", function () {
                    if (
                        $(
                            "#" + select_tag_region_id + " option:selected"
                        ).val() == ""
                    ) {
                        $("#" + select_tag_region_id + "")
                            .parent()
                ...
                <input type="text" id="` +
                                    select_tag_region_id +
                                    `_id" name="` +
                                    select_tag_region_id.replace("edit_", "") +
                                    `" placeholder="Error Fetching PH Location" class="w-100 form-control"/>
              `
                            );
                        $("#" + select_tag_province_id + "")
                            .parent()
                ...
                <input type="text" id="` +
                                    select_tag_province_id +
                                    `_id" name="` +
                                    select_tag_province_id.replace(
                                        "edit_",
                                        ""
                                    ) +
                                    `" placeholder="Error Fetching PH Location" class="w-100 form-control"/>
              `
                ...
                <input type="text" id="` +
                                    select_tag_city_id +
                                    `_id" name="` +
                                    select_tag_city_id.replace("edit_", "") +
                                    `" placeholder="Error Fetching PH Location" class="w-100 form-control"/>
              `
                            );
                        $("#" + select_tag_barangay_id + "")
                ...
                <input type="text" id="` +
                                    select_tag_barangay_id +
                                    `_id" name="` +
                                    select_tag_barangay_id.replace(
                                        "edit_",
                                        ""
                                    ) +
                                    `" placeholder="Error Fetching PH Location" class="w-100 form-control"/>
            ...
            $("#" + select_tag_region_id + "").change(function () {
                $("#" + select_tag_region_id + "_id").val(
                    $("#" + select_tag_region_id + " option:selected").text()
                );
            });
            $("#" + select_tag_province_id + "").change(function () {
                $("#" + select_tag_province_id + "_id").val(
                    $("#" + select_tag_province_id + " option:selected").text()
                );
            });
            $("#" + select_tag_city_id + "").change(function () {
                $("#" + select_tag_city_id + "_id").val(
                    $("#" + select_tag_city_id + " option:selected").text()
                );
            });
            $("#" + select_tag_barangay_id + "").change(function () {
                $("#" + select_tag_barangay_id + "_id").val(
                    $("#" + select_tag_barangay_id + " option:selected").text()
                );
            });
        }
    });
...
window.onload = function () {
    if (document.getElementById("im_type_of_service")) {
        var im_type_of_serviceSel =
            document.getElementById("im_type_of_service");
        var im_speci_intervSel = document.getElementById("im_speci_interv");
        for (var x in im_type_of_serviceObject) {
            im_type_of_serviceSel.options[
                im_type_of_serviceSel.options.length
            ] = new Option(x, x);
        }
        im_type_of_serviceSel.onchange = function () {
            ...
            for (var y in im_type_of_serviceObject[this.value]) {
                im_speci_intervSel.options[im_speci_intervSel.options.length] =
                    new Option(y, y);
            }
        };
        im_speci_intervSel.onchange = function () {
            //display correct values
            var z =
                im_type_of_serviceObject[im_type_of_serviceSel.value][
                    this.value
                ];
    ...
    if (document.getElementById("im_type_of_service_modal")) {
        var im_type_of_service_modalSel = document.getElementById(
            "im_type_of_service_modal"
        );
        var im_speci_interv_modalSel = document.getElementById(
            "im_speci_interv_modal"
        );
        for (var x in im_type_of_serviceObject) {
            im_type_of_service_modalSel.options[
                im_type_of_service_modalSel.options.length
            ] = new Option(x, x);
        }
        im_type_of_service_modalSel.onchange = function () {
            ...
            //display correct values
            for (var y in im_type_of_serviceObject[this.value]) {
                im_speci_interv_modalSel.options[
                    im_speci_interv_modalSel.options.length
                ] = new Option(y, y);
            }
        };
        im_speci_interv_modalSel.onchange = function () {
            //display correct values
            var z =
                im_type_of_serviceObject[im_type_of_service_modalSel.value][
                    this.value
                ];
            for (var i = 0; i < z.length; i++) {
                // chapterSel.options[chapterSel.options.length] = new Option(z[i], z[i]);
...
function changeTypeOfServiceAndSpecificInterventions(
    type_of_service,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $("#" + type_of_service + "").prepend(
                '<option value="">Please Select</option>'
            );
            $("#" + specific_interventions + "").prepend(
                '<option value="">Please Select</option>'
            );
            ...
            var im_type_of_serviceSel =
                document.getElementById(type_of_service);
            var im_speci_intervSel = document.getElementById(
                specific_interventions
            );
            for (var x in im_type_of_serviceObject) {
                im_type_of_serviceSel.options[
            ...
            im_type_of_serviceSel.onchange = function () {
                ...
                //display correct values
                for (var y in im_type_of_serviceObject[this.value]) {
                    im_speci_intervSel.options[
                        im_speci_intervSel.options.length
                    ] = new Option(y, y);
                }
            };
            im_speci_intervSel.onchange = function () {
...
$(function () {
    ...
    if ($("#employment_status option:selected").val() == "Employed") {
        ...
        $("#employment_status option:selected").val() == "Self-Employed"
    ) {
        $("#if_self_emp_pls_ind").removeAttr("readonly");
    }
...
$(function () {
    ...
    if (
        $("#relvic option:selected").val() == "Other Relatives, Specify:" ||
        $("#relvic option:selected").val() ==
            "Immediate Family Members, Specify:" ||
        $("#relvic option:selected").val() == "Stepfamily Members, Specify:"
    ) {
    ...
    $("#relvic").change(function (e) {
        ...
        if (
            selected_type == "Other Relatives, Specify:" ||
            selected_type == "Immediate Family Members, Specify:" ||
            selected_type == "Stepfamily Members, Specify:"
        ) {
            $("#inputRelvic").removeAttr("readonly");
        } else if (selected_type) {
...
if ($("#case_no").val()) {
    ...
    $.ajax({
        url:
            rootURL + "api/v1/case/get-case-form-status/" + $("#case_no").val(),
        success: function (result) {
            ...
            if (case_form_status != "Submitted") {
                ...
                $(function () {
                    ...
                    if (
                        $("#relvicsur option:selected").val() ==
                            "Other Relatives, Specify:" ||
                        $("#relvicsur option:selected").val() ==
                            "Immediate Family Members, Specify:" ||
                        $("#relvicsur option:selected").val() ==
                            "Stepfamily Members, Specify:"
                    ) {
...
$(function () {
    ...
    if (
        $("#rel_vict_sur_modal option:selected").val() ==
            "Other Relatives, Specify:" ||
        $("#rel_vict_sur_modal option:selected").val() ==
            "Immediate Family Members, Specify:" ||
        $("#rel_vict_sur_modal option:selected").val() ==
...
$(function () {
    ...
    if (
        $("#relvicsurModal option:selected").val() ==
            "Other Relatives, Specify:" ||
        $("#relvicsurModal option:selected").val() ==
            "Immediate Family Members, Specify:" ||
        $("#relvicsurModal option:selected").val() ==
...
$(function () {
    ...
    if ($("#im_speci_interv_modal option:selected").val() == "E. Others") {
        ...
        $("#im_speci_interv_modal option:selected").val() == "A. Others"
    ) {
        $("#inputspeIntModal").removeAttr("readonly");
    } else if (
        $("#im_speci_interv_modal option:selected").val() == "F. Others"
    ) {
        $("#inputspeIntModal").removeAttr("readonly");
    } else if (
        $("#im_speci_interv_modal option:selected").val() == "G. Others"
    ) {
        $("#inputspeIntModal").removeAttr("readonly");
    }
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == "") {
                ...
                $("#im_dsp_full_name").parent().empty()
                    .html(`<span><p class="card-text">Full Name</p></span>
              <input id="im_dsp_full_name" name="im_dsp_full_name" class="w-100 form-control" placeholder="No Directories"/>`);
                ...
                $("#im_dasp_full_name").parent().empty()
                    .html(`<span><p class="card-text">Full Name</p></span>
              ...
              `);
                ...
                result.forEach((element) => {
                    $("#im_dsp_full_name").append(
                        `<option value="` +
                            element["id"] +
                            `">` +
                            element["dir_first_name"] +
                            ` ` +
                            element["dir_last_name"] +
                            `</option>`
                    );
                    $("#im_dasp_full_name").append(
                        `<option value="` +
                            element["id"] +
                            `">` +
                            element["dir_first_name"] +
                ...
                $("#im_dsp_full_name").change(function () {
                    var service_provider_details = $(
                        "#im_dsp_full_name option:selected"
                    ).val();

                    // Put Name Text value to im_dsp_full_name_id hidden input
                    $("#im_dsp_full_name_id").val(
                        $("#im_dsp_full_name option:selected").text()
                    );

                    $.ajax({
                        url:
                            rootURL +
                            "api/v1/case/search-directory-details/" +
                            service_provider_details,
                        success: function (result) {
                            $("#im_dsp_post_desi").val(result.dir_post_desi);
                            $("#im_dsp_email").val(result.dir_email);
                            $("#im_dsp_contact_no_1").val(
                                result.dir_contact_no_1
                            );
                            $("#im_dsp_contact_no_2").val(
                                result.dir_contact_no_2
                            );
                            $("#im_dsp_contact_no_3").val(
                                result.dir_contact_no_3
                            );
                        },
                    });
                });
                ...
                $("#im_dasp_full_name").change(function () {
                    var service_provider_details = $(
                        "#im_dasp_full_name option:selected"
                    ).val();

                    // Put Name Text value to im_dasp_full_name_id hidden input
                    $("#im_dasp_full_name_id").val(
                        $("#im_dasp_full_name option:selected").text()
                    );
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == "") {
                ...
                $("#im_dsp_full_name_modal").parent().empty()
                    .html(`<span><p class="card-text">Full Name<span class="asterisk">*</span></p></span>
            <input id="im_dsp_full_name_modal" name="im_dsp_full_name_modal" class="w-100 form-control" placeholder="No Directories" required/>`);
                ...
                $("#im_dasp_full_name_modal").parent().empty()
                    .html(`<span><p class="card-text">Full Name</p></span>
            ...
            `);
                ...
                result.forEach((element) => {
                    ...
                    $("#im_dasp_full_name_modal").append(
                        `<option value="` +
                            element["id"] +
                            `">` +
                            element["dir_first_name"] +
...
function changeDirectories(
    service_provider_id,
    service_provider_full_name_id,
    service_provider_position_id,
    service_provider_email_id,
    service_provider_1st_contact_id,
    service_provider_2nd_contact_id,
    service_provider_3rd_contact_id
) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            var service_provider = $(
                "#" + service_provider_id + " option:selected"
            ).val();
          ...
          <input id="` +
                                    ...
                                    `" name="` +
                                    service_provider_full_name_id +
                                    `" class="w-100 form-control" placeholder="No Directories"/>`
                            );
            ...
            <input type="hidden" class="w-100 form-control" name="` +
                                    service_provider_full_name_id +
                                    `" id="` +
                                    service_provider_full_name_id +
                                    `_id"/>
          `
                        ...
                        result.forEach((element) => {
                            $("#" + service_provider_full_name_id + "").append(
                                `<option value="` +
                                    element["id"] +
                                    `">` +
                                    element["dir_first_name"] +
                        ...
                        $("#" + service_provider_full_name_id + "").change(
                            function () {
                                var service_provider_details = $(
                                    "#" +
                                        service_provider_full_name_id +
                                ...
                                $(
                                    "#" + service_provider_full_name_id + "_id"
                                ).val(
                                    $(
                                        "#" +
                                            service_provider_full_name_id +
                                    ...
                                    success: function (result) {
                                        $(
                                            "#" +
                                                service_provider_position_id +
                                                ""
                                        ).val(result.dir_post_desi);
                                        $(
                                            "#" + service_provider_email_id + ""
                                        ).val(result.dir_email);
                                        $(
                                            "#" +
                                                service_provider_1st_contact_id +
                                                ""
                                        ).val(result.dir_contact_no_1);
                                        $(
                                            "#" +
                                                service_provider_2nd_contact_id +
                                                ""
                                        ).val(result.dir_contact_no_2);
                                        $(
                                            "#" +
                                                service_provider_3rd_contact_id +
                                                ""
                                        ).val(result.dir_contact_no_3);
                                    },
                                });
                            }
                        );
...
function searchCase() {
    location.assign(
        rootURL +
            "admin/case-folder/master-list/search/" +
            $("#case_search_option option:selected").val() +
            "/" +
            $("#case_no_or_last_name_search").val()
    );
}
...
function searchUser() {
    location.assign(
        rootURL +
            "admin/rights-management/user/search/" +
            $("#user_last_name_search").val()
    );
}
...
function searchDirectories() {
    location.assign(
        rootURL +
            "admin/maintenance/directory/search/" +
            $("#directory_last_name_search").val()
    );
}
...
function sortListOfGBVCasesPerMonth() {
    location.assign(
        rootURL +
            "admin/report/sort-list-of-gbv-cases-per-month/" +
            $("#date_from_sort_gbv_cases_per_month").val() +
            "/" +
            $("#date_to_sort_gbv_cases_per_month").val()
    );
}
