                ...
                if($request->form_status == 'Submitted'){
                    ...
                    $validator = Validator::make(
                        ...
                        array(
                            ...
                            'id_chi_abu_sub_opt' => $request->id_chi_abu_efpaccp.$request->id_chi_abu_lasc_cond.$request->id_chi_abu_others.$request->id_chi_abu_sex_int.$request->id_chi_abu_phys_abu->id_chi_abu_neglected.$request->id_chi_abu_abandoned.$request,
                        ...
                        array(
                            ...
                            'perp_d_barangay' => '',
                            'perp_d_curr_loc' => '',
                            'perp_d_is_perp_minor' => '',
                            'perp_d_if_yes_pls_ind' => '',
                            'perp_d_addr_par_gua' => '',
                            'perp_d_cont_par_gua' => '',
                            'perp_d_rel_guar_perp' => '',
                    ...
                    if ($validator->fails()){
                        ...
                        IncidenceDetails::create([
                            ...
                            'id_chi_abu_neglected' => $request->id_chi_abu_neglected,
                            'id_chi_abu_abandoned' => $request->id_chi_abu_abandoned,
            ...
            if(str_contains($get_user_master_list_rights, "Add") == false){
                ...
                if(str_contains($get_case_no_cm_case_status, "Closed") == true){
                    ...
                    $validator = Validator::make($request->all(), [
                        ...
                        'fam_back_region_modal' => '',
                        'fam_back_province_modal' => '',
                        'fam_back_city_modal' => '',
                        'fam_back_barangay_modal' => '',
            ...
            if(str_contains($get_user_master_list_rights, "Add") == false){
                ...
                if(str_contains($get_case_no_cm_case_status, "Closed") == true){
                    ...
                    $validator = Validator::make($request->all(), [
                        ...
                        'inci_det_region_modal' => '',
                        'inci_det_province_modal' => '',
                        'inci_det_city_modal' => '',
                        'inci_det_barangay_modal' => '',
            ...
            if(str_contains($get_user_master_list_rights, "Add") == false){
                ...
                if(str_contains($get_case_no_cm_case_status, "Closed") == true){
                    ...
                    $validator = Validator::make($request->all(), [
                        ...
                        'case_no_modal' => '',
                        'perp_d_last_name_modal' => '',
                        'perp_d_first_name_modal' => '',
                        'perp_d_middle_name_modal' => '',
                        'perp_d_extension_name_modal' => '',
                        'perp_d_alias_name_modal' => '',
                        'perp_d_sex_radio_modal' => '',
                        'perp_d_birthdate_modal' => '',
                        'perp_d_age_modal' => '',
                        'perp_d_rel_victim_modal' => '',
                        'perp_d_rel_vic_pls_spec_modal' => '',
                        'perp_d_occup_modal' => '',
                        'perp_d_educ_att_modal' => '',
                        'perp_d_nationality_modal' => '',
                        'perp_d_nat_if_oth_pls_spec_modal' => '',
                        'perp_d_religion_modal' => '',
                        'perp_d_rel_if_oth_pls_spec_modal' => '',
                        'perp_d_house_no_modal' => '',
                        'perp_d_street_modal' => '',
                        'perp_d_region_modal' => '',
                        'perp_d_province_modal' => '',
                        'perp_d_city_modal' => '',
                        'perp_d_barangay_modal' => '',
                        'perp_d_curr_loc_modal' => '',
                        'perp_d_is_perp_minor_modal' => '',
                        'perp_d_if_yes_pls_ind_modal' => '',
                        'perp_d_addr_par_gua_modal' => '',
                        'perp_d_cont_par_gua_modal' => '',
                        'perp_d_rel_guar_perp_modal' => '',
