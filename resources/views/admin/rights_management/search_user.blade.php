  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6" style="display: flex; align-items: center;">
        <h1 class="text-gray-800">Search User</h1>
      ...
      <div class="card-body table-responsive">
        ...
        @csrf
          <div class="input-group">
            <input type="text" name="user_last_name_search" id="user_last_name_search" class="form-control bg-light border-0 small" placeholder="Enter Last Name" aria-label="Search" aria-describedby="basic-addon2" value="{{ $query_input }}">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card shadow">
            <div class="card-header">
                <span class="card-title h6 font-weight-bold text-primary" id="user_div_data_header_title">Search Results Table</span>
            </div>
          ...
          <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_active" id="is_active_yes_radio" value="Yes" />
                    <label class="form-check-label" for="is_active_yes_radio">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="is_active" id="is_active_no_radio" value="No" />
