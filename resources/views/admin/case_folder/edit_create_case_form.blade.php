                        ...
                        <fieldset>
                            <div class="card border-light shadow-lg">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col">
                                            <input type="checkbox" name="client_made_a_report_before" value="Yes" {{($editcaseformPerso[0]->client_made_a_report_before === 'Yes') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Date of Intake<span class="asterisk">*</span></p></span>
                                            <input type="date" name="date_of_intake" class="w-100 date text-box form-control" value="{{$editcaseformPerso[0]->date_of_intake}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Case No.<span class="asterisk">*</span></p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->case_no }}" id="case_no" name="case_no" placeholder="" class="w-100 form-control" readonly/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Type of Client<span class="asterisk">*</span></p></span>
                                            <select name="type_of_client" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                ...
                                                <option value="Walk-In" {{($editcaseformPerso[0]->type_of_client === 'Walk-In') ? 'Selected' : ''}}>Walk-In</option>
                                                <option value="Referral" {{($editcaseformPerso[0]->type_of_client === 'Referral') ? 'Selected' : ''}}>Referral</option>
                                                <option value="Reach out" {{($editcaseformPerso[0]->type_of_client === 'Reach out') ? 'Selected' : ''}}>Reach out</option>
                                                <option value="Text / Call" {{($editcaseformPerso[0]->type_of_client === 'Text / Call') ? 'Selected' : ''}}>Text / Call</option>
                                                <option value="Online Platforms" {{($editcaseformPerso[0]->type_of_client === 'Online Platforms') ? 'Selected' : ''}}>Online Platforms</option>
                                            </select>
                                        </div>
                                    </div>    
                                    <div class="row mb-3">    
                                        <div class="col"><span><p class="card-text">Last Name<span class="asterisk">*</span></p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->last_name }}" name="last_name" placeholder="Last name" class="w-100 form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">First Name<span class="asterisk">*</span></p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->first_name }}" name="first_name" placeholder="First name" class="w-100 form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Middle Name<span class="asterisk">*</span></p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->middle_name }}" name="middle_name" placeholder="Middle name" class="w-100 form-control" />
                                        </div>
                                    </div>  
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Extension</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->extension_name }}" name="extension_name" placeholder="" class="w-100 form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Nickname/Alias</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->alias_name }}" name="alias_name" placeholder="" class="w-100 form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Sex<span class="asterisk">*</span></p></span>
                                            <select name="sex" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Male" {{($editcaseformPerso[0]->sex === 'Male') ? 'Selected' : ''}}>Male</option>
                                                <option value="Female" {{($editcaseformPerso[0]->sex === 'Female') ? 'Selected' : ''}}>Female</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">    
                                        <div class="col"><span><p class="card-text">Birthdate<span class="asterisk">*</span></p></span>
                                            <input type="date" value="{{ $editcaseformPerso[0]->birth_date }}" name="birth_date" class="w-100 date text-box form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Age<span class="asterisk">*</span></p></span>
                                            <input type="number" value="{{$editcaseformPerso[0]->age }}" name="age" placeholder="" class="w-100 form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Civil Status<span class="asterisk">*</span></p></span>
                                            <select name="civil_status" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Single" {{($editcaseformPerso[0]->civil_status === 'Single') ? 'Selected' : ''}}>Single</option>
                                                <option value="Legally Married" {{($editcaseformPerso[0]->civil_status === 'Legally Married') ? 'Selected' : ''}}>Legally Married</option>
                                                <option value="Consensual, Common Law, or Live-In Partner" {{($editcaseformPerso[0]->civil_status === 'Consensual, Common Law, or Live-In Partner') ? 'Selected' : ''}}>Consensual, Common Law, or Live-In Partner</option>
                                                <option value="Legally Separated" {{($editcaseformPerso[0]->civil_status === 'Legally Separated') ? 'Selected' : ''}}>Legally Separated</option>
                                                <option value="Separated in Fact" {{($editcaseformPerso[0]->civil_status === 'Separated in Fact') ? 'Selected' : ''}}>Separated in Fact</option>
                                                <option value="Windowed" {{($editcaseformPerso[0]->civil_status === 'Windowed') ? 'Selected' : ''}}>Windowed</option>
                                                <option value="Anulled" {{($editcaseformPerso[0]->civil_status === 'Anulled') ? 'Selected' : ''}}>Anulled</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Is the client a person with diverse SOGIE:<span class="asterisk">*</span></p></span>
                                            <select name="client_diverse_sogie" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Yes" {{($editcaseformPerso[0]->client_diverse_sogie === 'Yes') ? 'Selected' : ''}}>Yes</option>
                                                <option value="No" {{($editcaseformPerso[0]->client_diverse_sogie === 'No') ? 'Selected' : ''}}>No</option>
                                            </select>
                                        </div>
                                        <div class="col"><span><p class="card-text">Educational Attainment:<span class="asterisk">*</span></p></span>
                                            <select name="education" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="No Formal Education" {{($editcaseformPerso[0]->education === 'No Formal Education') ? 'Selected' : ''}}>No Formal Education</option>
                                                <option value="Elementary Level/Graduate" {{($editcaseformPerso[0]->education === 'Elementary Level/Graduate') ? 'Selected' : ''}}>Elementary Level/Graduate</option>
                                                <option value="Junior High School Level/Graduate" {{($editcaseformPerso[0]->education === 'Junior High School Level/Graduate') ? 'Selected' : ''}}>Junior High School Level/Graduate</option>
                                                <option value="Senior High School Level/Graduate" {{($editcaseformPerso[0]->education === 'Senior High School Level/Graduate') ? 'Selected' : ''}}>Senior High School Level/Graduate</option>
                                                <option value="Technical/Vocational" {{($editcaseformPerso[0]->education === 'Technical/Vocational') ? 'Selected' : ''}}>Technical/Vocational</option>
                                                <option value="College Level/Graduate" {{($editcaseformPerso[0]->education === 'College Level/Graduate') ? 'Selected' : ''}}>College Level/Graduate</option>
                                                <option value="Post Graduate" {{($editcaseformPerso[0]->education === 'Post Graduate') ? 'Selected' : ''}}>Post Graduate</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Religion<span class="asterisk">*</span></p></span>
                                            <select id="religion" name="religion" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeReligion('religion')">
                                                ...
                                                @else
                                                <option value="{{ $editcaseformPerso[0]->religion }}" selected>{{ $editcaseformPerso[0]->religion }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col"><span><p class="card-text">If Others, please specify</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->religion_if_oth_pls_spec }}" name="religion_if_oth_pls_spec" placeholder="" class="w-100 form-control religionInput" id="inputRel"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">    
                                        <div class="col"><span><p class="card-text">Nationality<span class="asterisk">*</span></p></span>
                                            <select id="nationality" name="nationality" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Filipino" {{($editcaseformPerso[0]->nationality === 'Filipino') ? 'Selected' : ''}}>Filipino</option>
                                                <option value="Others" {{($editcaseformPerso[0]->nationality === 'Others') ? 'Selected' : ''}}>Others</option>
                                            </select>
                                        </div>
                                        <div class="col"><span><p class="card-text">If Others, please specify</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->nationality_if_oth_pls_spec}}" name="nationality_if_oth_pls_spec" placeholder="" class="w-100 form-control nationalityInput" id="inputNa"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3"> 
                                        <div class="col"><span><p class="card-text">Ethnicity<span class="asterisk">*</span></p></span>
                                            <select id="ethnicity" name="ethnicity" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Bisaya" {{($editcaseformPerso[0]->ethnicity === 'Bisaya') ? 'Selected' : ''}}>Bisaya</option>
                                                <option value="Ilongo" {{($editcaseformPerso[0]->ethnicity === 'Ilongo') ? 'Selected' : ''}}>Ilongo</option>
                                                <option value="Iranon" {{($editcaseformPerso[0]->ethnicity === 'Iranon') ? 'Selected' : ''}}>Iranon</option>
                                                <option value="Maguindanaon" {{($editcaseformPerso[0]->ethnicity === 'Maguindanaon') ? 'Selected' : ''}}>Maguindanaon</option>
                                                <option value="Meranao" {{($editcaseformPerso[0]->ethnicity === 'Meranao') ? 'Selected' : ''}}>Meranao</option>
                                                <option value="Teduray" {{($editcaseformPerso[0]->ethnicity === 'Teduray') ? 'Selected' : ''}}>Teduray</option>
                                                <option value="Tausug" {{($editcaseformPerso[0]->ethnicity === 'Tausug') ? 'Selected' : ''}}>Tausug</option>
                                                <option value="Others" {{($editcaseformPerso[0]->ethnicity === 'Others') ? 'Selected' : ''}}>Others</option>
                                            </select>
                                        </div>
                                        <div class="col"><span><p class="card-text">If Others, please specify</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->ethnicity_if_oth_pls_spec}}" name="ethnicity_if_oth_pls_spec" placeholder="" class="w-100 form-control ethnicityInput" id="inputEth"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3"> 
                                        <div class="col"><span><p class="card-text">Employment Status:<span class="asterisk">*</span></p></span>
                                            <select id="employment_status" name="employment_status" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                ...
                                                <option value="Employed" {{($editcaseformPerso[0]->employment_status === 'Employed') ? 'Selected' : ''}}>Employed</option>
                                                <option value="Self-Employed" {{($editcaseformPerso[0]->employment_status === 'Self-Employed') ? 'Selected' : ''}}>Self-Employed</option>
                                                <option value="Unemployed" {{($editcaseformPerso[0]->employment_status === 'Unemployed') ? 'Selected' : ''}}>Unemployed</option>
                                            </select>
                                        </div>
                                        <div class="col"><span><p class="card-text">If Employed or Self-Employed: Please Indicate</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->if_self_emp_pls_ind}}" id="if_self_emp_pls_ind" name="if_self_emp_pls_ind" placeholder="" class="w-100 form-control selfemployedInput"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Household No.</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->house_hold_no}}" name="house_hold_no" class="form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Street</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->street}}" name="street" class="w-100 form-control" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Region<span class="asterisk">*</span></p></span>
                                            <select id="edit_region" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_region', 'edit_province', 'edit_city', 'edit_barangay')">
                                                    <option value="{{$editcaseformPerso[0]->region}}" selected>{{$editcaseformPerso[0]->region}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_region_id" name="region" value="{{$editcaseformPerso[0]->region}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Province<span class="asterisk">*</span></p></span>
                                            <select id="edit_province" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_region', 'edit_province', 'edit_city', 'edit_barangay')">
                                                <option value="{{$editcaseformPerso[0]->province}}" selected>{{$editcaseformPerso[0]->province}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_province_id" name="province" value="{{$editcaseformPerso[0]->province}}"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                         <div class="col"><span><p class="card-text">City/Municipality<span class="asterisk">*</span></p></span>
                                            <select id="edit_city" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_region', 'edit_province', 'edit_city', 'edit_barangay')">
                                                <option value="{{$editcaseformPerso[0]->city}}" selected>{{$editcaseformPerso[0]->city}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_city_id" name="city" value="{{$editcaseformPerso[0]->city}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Barangay<span class="asterisk">*</span></p></span>
                                            <select id="edit_barangay" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_region', 'edit_province', 'edit_city', 'edit_barangay')">
                                                <option value="{{$editcaseformPerso[0]->barangay}}" selected>{{$editcaseformPerso[0]->barangay}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_barangay_id" name="barangay" value="{{$editcaseformPerso[0]->barangay}}"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-3"><span><p class="card-text">Is IDP?<span class="asterisk">*</span></p></span>
                                            <div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="is_idp" id="is_idp_yes_radio" value="Yes" {{($editcaseformPerso[0]->is_idp === 'Yes') ? 'Checked' : ''}}/>
                                                    <label class="form-check-label" for="is_idp_yes_radio">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="is_idp" id="is_idp_no_radio" value="No" {{($editcaseformPerso[0]->is_idp === 'No') ? 'Checked' : ''}}/>
                                        ...
                                        <div class="col-md-3"><span><p class="card-text">Is PWD?<span class="asterisk">*</span></p></span>
                                            <div>
                                                <div class="form-check">
                                                    <input class="form-check-input ispwd" type="radio" name="is_pwd" id="is_pwd_yes_radio" value="Yes" {{($editcaseformPerso[0]->is_pwd === 'Yes') ? 'Checked' : ''}}/>
                                                    <label class="form-check-label" for="is_pwd_yes_radio">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input ispwd" type="radio" name="is_pwd" id="is_pwd_no_radio" value="No" {{($editcaseformPerso[0]->is_pwd === 'No') ? 'Checked' : ''}}/>
                                        ...
                                        <div class="col"><span><p class="card-text">If PWD, please specify</p></span>
                                            <input type="text" value="{{$editcaseformPerso[0]->if_pwd_pls_specify}}" id="if_pwd_pls_specify" name="if_pwd_pls_specify" placeholder="" class="w-100 form-control ifpwdInput" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <input type="text" value="{{$editcaseformFambac[0]->name_par_guar }}" class="w-50 form-control" name="name_par_guar"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Occupation:<span class="asterisk">*</span></p></span>
                                            <input type="text" value="{{$editcaseformFambac[0]->job_vict_sur }}" class="w-100 form-control" name="job_vict_sur"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Age:<span class="asterisk">*</span></p></span>
                                            <input type="number" value="{{$editcaseformFambac[0]->age_vict_sur }}" class="w-50 form-control" name="age_vict_sur"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col"><span><p class="card-text">Relationship to the Victim-Survivor:<span class="asterisk">*</span></p></span>
                                            <select id="relvic" name="rel_vict_sur" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeRelationshipToTheVictimSurvivor('relvic')">
                                                ...
                                                @else
                                                <option value="{{ $editcaseformFambac[0]->rel_vict_sur }}" selected>{{ $editcaseformFambac[0]->rel_vict_sur ?? 'Please Select'}}</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Others, please specify:</p></span>
                                            <input type="text" value="{{$editcaseformFambac[0]->rttvs_if_oth_pls_spec }}" class="w-100 form-control relvicInput" name="rttvs_if_oth_pls_spec" id="inputRelvic"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <input type="text" value="{{$editcaseformFambac[0]->fam_back_house_no }}" name="fam_back_house_no" class="form-control" />
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Street</p></span>
                                            <input type="text" value="{{$editcaseformFambac[0]->fam_back_street }}" class="w-100 form-control" name="fam_back_street" />
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col"><span><p class="card-text">Region<span class="asterisk">*</span></p></span>
                                            <select id="edit_fam_back_region" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_fam_back_region', 'edit_fam_back_province', 'edit_fam_back_city', 'edit_fam_back_barangay')">
                                                <option value="{{$editcaseformFambac[0]->fam_back_region}}" selected>{{$editcaseformFambac[0]->fam_back_region}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_fam_back_region_id" name="fam_back_region" value="{{$editcaseformFambac[0]->fam_back_region}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Province<span class="asterisk">*</span></p></span>
                                            <select id="edit_fam_back_province" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_fam_back_region', 'edit_fam_back_province', 'edit_fam_back_city', 'edit_fam_back_barangay')">
                                                <option value="{{$editcaseformFambac[0]->fam_back_province}}" selected>{{$editcaseformFambac[0]->fam_back_province}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_fam_back_province_id" name="fam_back_province" value="{{$editcaseformFambac[0]->fam_back_province}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col"><span><p class="card-text">City/Municipality<span class="asterisk">*</span></p></span>
                                            <select id="edit_fam_back_city" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_fam_back_region', 'edit_fam_back_province', 'edit_fam_back_city', 'edit_fam_back_barangay')">
                                                <option value="{{$editcaseformFambac[0]->fam_back_city}}" selected>{{$editcaseformFambac[0]->fam_back_city}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_fam_back_city_id" name="fam_back_city" value="{{$editcaseformFambac[0]->fam_back_city}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Barangay<span class="asterisk">*</span></p></span>
                                            <select id="edit_fam_back_barangay" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_fam_back_region', 'edit_fam_back_province', 'edit_fam_back_city', 'edit_fam_back_barangay')">
                                                <option value="{{$editcaseformFambac[0]->fam_back_barangay}}" selected>{{$editcaseformFambac[0]->fam_back_barangay}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_fam_back_barangay_id" name="fam_back_barangay" value="{{$editcaseformFambac[0]->fam_back_barangay}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-md-5"><p class="card-text">Contact Number:<span class="asterisk">*</span></p>
                                            <input type="text" value="{{$editcaseformFambac[0]->fam_back_cont_num }}" class="w-100 form-control" name="fam_back_cont_num" />
                                        </div>
                                    </div>
                                            ...
                                            <tbody id="fam_back_table_tbody">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="javascript:void(0)" class="text-orange-icon" data-bs-toggle="modal" data-bs-target="#fam_back_modal" onclick="getSpecificAdditionalFamilyBackgroundForm({{ $family_background_info->id }}, `Edit`)"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        ...
                                                        <a href="javascript:void(0)" class="text-orange-icon" onclick="deleteSpecificAdditionalFamilyBackgroundModal({{ $family_background_info->id }})"><i class="fa fa-trash"></i></a>
                                                        @endif
                                                    </td>
                            ...
                            <div class="card border-light shadow-lg">
                                ...
                                <div class="card-body">  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8"><input type="date" class="w-100 form-control" name="id_date_int" value="{{ $editcaseformInci[0]->id_date_int }}"/></div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-md-4"><p class="card-text">Name of Interviewer:<span class="asterisk">*</span></p></div>
                                        <div class="col-md-8"><input type="text" value="{{ $editcaseformInci[0]->id_name_intervi }}" class="w-100 form-control" name="id_name_intervi" /></div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-md-4"><p class="card-text">Position/Designation of Interviewer:<span class="asterisk">*</span></p></div>
                                        <div class="col-md-8"><input type="text" value="{{ $editcaseformInci[0]->id_pos_desi_int }}" class="w-100 form-control" name="id_pos_desi_int" /></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-3"><span><p class="card-text">Nature of Incidence:<span class="asterisk">*</span></p></span></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><input type="checkbox" name="id_int_part_vio" value="Intimate partner violence" {{($editcaseformInci[0]->id_int_part_vio === 'Intimate partner violence') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_ipv_phys" value="Physical" {{($editcaseformInci[0]->id_ipv_phys === 'Physical') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Physical
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_ipv_sexual" value="Sexual" {{($editcaseformInci[0]->id_ipv_sexual  === 'Sexual') ? 'Checked' : ''}} id="flexCheckChecked" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_ipv_psycho" value="Psychological" {{($editcaseformInci[0]->id_ipv_psycho  === 'Psychological') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Psychological
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_ipv_econo" value="Economic" {{($editcaseformInci[0]->id_ipv_econo  === 'Economic') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Economic
                                                </label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><input type="checkbox" name="id_rape" value="Rape" {{($editcaseformInci[0]->id_rape  === 'Rape') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_rape_incest" value="Incest" {{($editcaseformInci[0]->id_rape_incest  === 'Incest') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Incest
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_rape_sta_rape" value="Statutory Rape" {{($editcaseformInci[0]->id_rape_sta_rape  === 'Statutory Rape') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Statutory Rape
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_rape_sex_int" value="Rape by Sexual Intercourse" {{($editcaseformInci[0]->id_rape_sex_int  === 'Rape by Sexual Intercourse') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Rape by Sexual Intercourse
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_rape_sex_assa" value="Rape by Sexual Assault" {{($editcaseformInci[0]->id_rape_sex_assa  === 'Rape by Sexual Assault') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Rape by Sexual Assault
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_rape_mar_rape" value="Marital Rape" {{($editcaseformInci[0]->id_rape_mar_rape  === 'Marital Rape') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Marital Rape
                                                </label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><input type="checkbox" name="id_traf_per" value="Trafficking in Person" {{($editcaseformInci[0]->id_traf_per  === 'Trafficking in Person') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_traf_per_sex_exp" value="Sexual Exploitation" {{($editcaseformInci[0]->id_traf_per_sex_exp  === 'Sexual Exploitation') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Sexual Exploitation
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_traf_per_onl_exp" value="Online Exploitation"  {{($editcaseformInci[0]->id_traf_per_onl_exp  === 'Online Exploitation') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Online Exploitation
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_traf_per_others" value="Others" {{($editcaseformInci[0]->id_traf_per_others  === 'Others') ? 'Checked' : ''}} id="trafPer" onchange="trafPers()"/>
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Others
                                                </label>
                                                <span><input type="text" value="{{$editcaseformInci[0]->id_traf_per_others_spec }}" class="w-100 form-control" placeholder="Please specify" name="id_traf_per_others_spec" id="inputTrafper"/></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_traf_per_forc_lab" value="Forced Labor" {{($editcaseformInci[0]->id_traf_per_forc_lab === 'Forced Labor') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Forced Labor
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_traf_per_srem_org" value="Sale or Removal of Organs" {{($editcaseformInci[0]->id_traf_per_srem_org === 'Sale or Removal of Organs') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Sale or Removal of Organs
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_traf_per_prost" value="Prostitution" {{($editcaseformInci[0]->id_traf_per_prost === 'Prostitution') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Prostitution
                                                </label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><input type="checkbox" name="id_sex_hara" value="Sexual Harassment" {{($editcaseformInci[0]->id_sex_hara === 'Sexual Harassment') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_sex_hara_ver" value="Verbal" {{($editcaseformInci[0]->id_sex_hara_ver === 'Verbal') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Verbal
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_sex_hara_others" value="Others" {{($editcaseformInci[0]->id_sex_hara_others === 'Others') ? 'Checked' : ''}} id="sexHa" onchange="sexHas()"/>
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Others
                                                </label>
                                                <span><input type="text" value="{{$editcaseformInci[0]->id_sex_hara_others_spec }}" class="w-100 form-control" placeholder="Please specify" name="id_sex_hara_others_spec" id="inputSexHa"/></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_sex_hara_phys" value="Physical" {{($editcaseformInci[0]->id_sex_hara_phys === 'Physical') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Physical
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_sex_hara_use_obj" value="Use of Object, Letters, or Notes with Sexual Undeskpinning" {{($editcaseformInci[0]->id_sex_hara_use_obj === 'Use of Object, Letters, or Notes with Sexual Undeskpinning') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><input type="checkbox" name="id_chi_abu" value="Child Abuse, Exploitation and Discrimination" {{($editcaseformInci[0]->id_chi_abu === 'Child Abuse, Exploitation and Discrimination') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_chi_abu_efpaccp" value="Engage, Facilitate, Promote, or Attempt to Commit Child Prostitution" {{($editcaseformInci[0]->id_chi_abu_efpaccp === 'Engage, Facilitate, Promote, or Attempt to Commit Child Prostitution') ? 'Checked' : ''}} id="flexCheckDefault" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Engage, Facilitate, Promote, or Attempt to Commit Child Prostitution
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_chi_abu_lasc_cond" value="Lascivious Conduct" {{($editcaseformInci[0]->id_chi_abu_lasc_cond === 'Lascivious Conduct') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Lascivious Conduct
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_chi_abu_others" value="Others" {{($editcaseformInci[0]->id_chi_abu_others === 'Others') ? 'Checked' : ''}} id="chiAed" onchange="chiAeds()"/>
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Others
                                                </label>
                                                <span><input type="text" class="w-100 form-control" placeholder="Please specify" name="id_chi_abu_others_spec"  id="inputchiAed" value="{{$editcaseformInci[0]->id_chi_abu_others_spec}}"/></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_chi_abu_sex_int" value="Sexual Intercourse" {{($editcaseformInci[0]->id_chi_abu_sex_int === 'Sexual Intercourse') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Sexual Intercourse
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="id_chi_abu_phys_abu" value="Physical Abuse" {{($editcaseformInci[0]->id_chi_abu_phys_abu === 'Physical Abuse') ? 'Checked' : ''}} id="flexCheckChecked" />
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Physical Abuse
                                                </label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9 form-floating">
                                            <textarea class="form-control" placeholder="Leave a comment here" name="id_descr_inci" id="floatingTextarea2" rows="14">{{$editcaseformInci[0]->id_descr_inci}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Date of Incidence:<span class="asterisk">*</span></p></span>
                                            <input type="date" class="w-100 form-control" name="id_date_of_inci" value="{{$editcaseformInci[0]->id_date_of_inci }}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Time of Incident:</p></span>
                                            <input type="time" class="w-100 form-control" name="id_time_of_inci" value="{{$editcaseformInci[0]->id_time_of_inci }}"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row my-3">
                                        <div class="col"><span><p class="card-text">Household No.</p></span>
                                            <input type="text" value="{{$editcaseformInci[0]->inci_det_house_no }}" name="inci_det_house_no" class="form-control" />
                                        </div>
                                        <div class="col"><span><p class="card-text">Street</p></span>
                                            <input type="text" class="w-100 form-control" value="{{$editcaseformInci[0]->inci_det_street }}" name="inci_det_street" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Region<span class="asterisk">*</span></p></span>
                                            <select id="edit_inci_det_region" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_inci_det_region', 'edit_inci_det_province', 'edit_inci_det_city', 'edit_inci_det_barangay')">
                                                <option value="{{$editcaseformInci[0]->inci_det_region}}" selected>{{$editcaseformInci[0]->inci_det_region}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_inci_det_region_id" name="inci_det_region" value="{{$editcaseformInci[0]->inci_det_region}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Province<span class="asterisk">*</span></p></span>
                                            <select id="edit_inci_det_province" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_inci_det_region', 'edit_inci_det_province', 'edit_inci_det_city', 'edit_inci_det_barangay')">
                                                <option value="{{$editcaseformInci[0]->inci_det_province}}" selected>{{$editcaseformInci[0]->inci_det_province}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_inci_det_province_id" name="inci_det_province" value="{{$editcaseformInci[0]->inci_det_province}}"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">City/Municipality<span class="asterisk">*</span></p></span>
                                            <select id="edit_inci_det_city" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_inci_det_region', 'edit_inci_det_province', 'edit_inci_det_city', 'edit_inci_det_barangay')">
                                                <option value="{{$editcaseformInci[0]->inci_det_city}}" selected>{{$editcaseformInci[0]->inci_det_city}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_inci_det_city_id" name="inci_det_city" value="{{$editcaseformInci[0]->inci_det_city}}"/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Barangay<span class="asterisk">*</span></p></span>
                                            <select id="edit_inci_det_barangay" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_inci_det_region', 'edit_inci_det_province', 'edit_inci_det_city', 'edit_inci_det_barangay')">
                                                <option value="{{$editcaseformInci[0]->inci_det_barangay}}" selected>{{$editcaseformInci[0]->inci_det_barangay}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_inci_det_barangay_id" name="inci_det_barangay" value="{{$editcaseformInci[0]->inci_det_barangay}}"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Place of Incidence:<span class="asterisk">*</span></p></span>
                                            <select id="placeinci" name="id_pla_of_inci" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changePlaceOfIncidence('placeinci')">
                                                ...
                                                <option value="Others">Others</option>
                                                @else
                                                <option value="{{ $editcaseformInci[0]->id_pla_of_inci }}" selected>{{ $editcaseformInci[0]->id_pla_of_inci }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col"><span><p class="card-text">If Others, please specify</p></span>
                                            <input type="text" value="{{$editcaseformInci[0]->id_pi_oth_pls_spec }}" name="id_pi_oth_pls_spec" placeholder="" class="w-100 form-control placeInci" id="inputplaceInci"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <select name="id_was_inc_perp_onl" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Yes" {{($editcaseformInci[0]->id_was_inc_perp_onl === 'Yes') ? 'Selected' : '' }}>Yes</option>
                                                <option value="No" {{($editcaseformInci[0]->id_was_inc_perp_onl === 'No') ? 'Selected' : '' }}>No</option>
                                            </select>   
                                        </div>
                                    </div>
                                    @if($master_list_rights_add == true)      
                                        ...
                                        <table class="table table-hover no-footer">
                                            ...
                                            <tbody id="inci_det_table_tbody">
                                                ...
                                                <tr>
                                                    <td>
                                                        @if(($master_list_rights_revise == true) && ($editcaseformCaseMod[0]->cm_case_status != 'Closed'))
                                                        <a href="javascript:void(0)" class="text-orange-icon" data-bs-toggle="modal" data-bs-target="#modalIncidenceDetails" onclick="getSpecificAdditionalIncidenceDetailsForm({{ $incidence_detail_info->id }}, `Edit`)"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        ...
                                                        @if(($master_list_rights_delete == true) && ($editcaseformCaseMod[0]->cm_case_status != 'Closed'))
                                                        <a href="javascript:void(0)" class="text-orange-icon" onclick="deleteSpecificAdditionalIncidenceDetailsModal({{ $incidence_detail_info->id }})"><i class="fa fa-trash"></i></a>
                                                        @endif
                                                    </td>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col">
                                            ...
                                            <input type="text" class="w-100 form-control" value="{{$editcaseformPerpet[0]->perp_d_last_name }}" name="perp_d_last_name" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">First Name<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" value="{{$editcaseformPerpet[0]->perp_d_first_name }}" name="perp_d_first_name" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Middle Name<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" value="{{$editcaseformPerpet[0]->perp_d_middle_name }}" name="perp_d_middle_name" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <span><p class="card-text">Extension</p></span>
                                            <input type="text" class="w-50 form-control" value="{{$editcaseformPerpet[0]->perp_d_extension_name }}" name="perp_d_extension_name" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Nickname/Alias</p></span>
                                            <input type="text" class="w-50 form-control" value="{{$editcaseformPerpet[0]->perp_d_alias_name }}" name="perp_d_alias_name" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-1">
                                        ...
                                        <div class="col">
                                            <div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="perp_d_sex_radio" id="perp_d_sex_male_radio" value="Male" {{($editcaseformPerpet[0]->perp_d_sex_radio === 'Male') ? 'Checked' : ''}} {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}/>
                                                    <label class="form-check-label" for="perp_d_sex_male_radio">Male</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="perp_d_sex_radio" id="perp_d_sex_female_radio" value="Female" {{($editcaseformPerpet[0]->perp_d_sex_radio === 'Female') ? 'Checked' : ''}} {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}/>
                                                    <label class="form-check-label" for="perp_d_sex_female_radio">Female</label>
                                                </div>
                                                @if($cases_details[0]->form_status == 'Submitted')
                                                <input type="hidden" name="perp_d_sex_radio" value="{{$editcaseformPerpet[0]->perp_d_sex_radio}}" />
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <span><p class="card-text">Birthdate:<span class="asterisk">*</span></p></span>
                                            <input type="date" class="w-100 form-control" name="perp_d_birthdate" value="{{$editcaseformPerpet[0]->perp_d_birthdate}}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col-md-3">
                                            <span><p class="card-text">Age:<span class="asterisk">*</span></p></span>
                                            <input type="number" class="w-100 form-control" name="perp_d_age" value="{{$editcaseformPerpet[0]->perp_d_age }}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <span><p class="card-text">Relationship to the Victim-Survivor:<span class="asterisk">*</span></p></span>
                                            <select id="relvicsur" name="perp_d_rel_victim" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeRelationshipToTheVictimSurvivor('relvicsur')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                ...
                                                <option value="Other Relatives, Specify:">Other Relatives, Specify:</option>
                                                @else    
                                                <option value="{{ $editcaseformPerpet[0]->perp_d_rel_victim }}" selected>{{ $editcaseformPerpet[0]->perp_d_rel_victim }}</option>
                                                @endif
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" name="perp_d_rel_victim" value="{{$editcaseformPerpet[0]->perp_d_rel_victim}}" />
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Other, please specify:</p></span>
                                            <input type="text" class="w-100 form-control relVicsur" value="{{$editcaseformPerpet[0]->perp_d_rel_vic_pls_spec }}" id="inputrelvicsur" name="perp_d_rel_vic_pls_spec" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }} />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <span><p class="card-text">Occupation:<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" value="{{$editcaseformPerpet[0]->perp_d_occup }}" name="perp_d_occup" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col-md-6">
                                            <span><p class="card-text">Educational Attainment:<span class="asterisk">*</span></p></span>
                                            <select name="perp_d_educ_att" aria-aria-controls='example' class="date-picker w-100 form-control" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="">Please Select</option>
                                                <option value="No Formal Education" {{($editcaseformPerpet[0]->perp_d_educ_att === 'No Formal Education') ? 'Selected' : ''}}>No Formal Education</option>
                                                <option value="Elementary Level/Graduate" {{($editcaseformPerpet[0]->perp_d_educ_att === 'Elementary Level/Graduate') ? 'Selected' : ''}}>Elementary Level/Graduate</option>
                                                <option value="Junior High School Level/Graduate" {{($editcaseformPerpet[0]->perp_d_educ_att === 'Junior High School Level/Graduate') ? 'Selected' : ''}}>Junior High School Level/Graduate</option>
                                                <option value="Senior High School Level/Graduate" {{($editcaseformPerpet[0]->perp_d_educ_att === 'Senior High School Level/Graduate') ? 'Selected' : ''}}>Senior High School Level/Graduate</option>
                                                <option value="Technical/Vocational" {{($editcaseformPerpet[0]->perp_d_educ_att === 'Technical/Vocational') ? 'Selected' : ''}}>Technical/Vocational</option>
                                                <option value="College Level/Graduate" {{($editcaseformPerpet[0]->perp_d_educ_att === 'College Level/Graduate') ? 'Selected' : ''}}>College Level/Graduate</option>
                                                <option value="Post Graduate" {{($editcaseformPerpet[0]->perp_d_educ_att === 'Post Graduate') ? 'Selected' : ''}}>Post Graduate</option>
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" class="w-100 form-control" value="{{$editcaseformPerpet[0]->perp_d_educ_att }}" name="perp_d_educ_att"/>
                                            @endif                                        
                                        </div>
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <select id="narelvicsur" name="perp_d_nationality" aria-aria-controls='example' class="date-picker w-100 form-control" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="">Please Select</option>
                                                <option value="Filipino" {{($editcaseformPerpet[0]->perp_d_nationality === 'Filipino') ? 'Selected' : ''}}>Filipino</option>
                                                <option value="Others" {{($editcaseformPerpet[0]->perp_d_nationality === 'Others') ? 'Selected' : ''}}>Others</option>
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" name="perp_d_nationality" value="{{$editcaseformPerpet[0]->perp_d_nationality}}" />
                                            @endif
                                        </div>
                                        <div class="col"><span><p class="card-text">If Others, please specify</p></span>
                                            <input type="text" value="{{$editcaseformPerpet[0]->perp_d_nat_if_oth_pls_spec }}" name="perp_d_nat_if_oth_pls_spec" placeholder="" class="w-100 form-control narelVicsur" id="nainputrelvicsur" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Religion<span class="asterisk">*</span></p></span>
                                            <select id="rerelvicsur" name="perp_d_religion" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeReligion('rerelvicsur')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                ...
                                                <option value="Others">Others</option>
                                                @else
                                                <option value="{{ $editcaseformPerpet[0]->perp_d_religion }}" selected>{{ $editcaseformPerpet[0]->perp_d_religion }}</option>
                                                @endif
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" name="perp_d_religion" value="{{$editcaseformPerpet[0]->perp_d_religion}}" />
                                            @endif
                                        </div>
                                        <div class="col"><span><p class="card-text">If Others, please specify</p></span>
                                            <input type="text" value="{{$editcaseformPerpet[0]->perp_d_rel_if_oth_pls_spec }}" name="perp_d_rel_if_oth_pls_spec" placeholder="" class="w-100 form-control rerelVicsur" id="reinputrelvicsur" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-3"><span><p class="card-text">Address</p></span></div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col"><span><p class="card-text">Household No.</p></span>
                                            <input type="text" value="{{$editcaseformPerpet[0]->perp_d_house_no }}" name="perp_d_house_no" class="form-control" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col"><span><p class="card-text">Street</p></span>
                                            <input type="text" value="{{$editcaseformPerpet[0]->perp_d_street }}" name="perp_d_street" class="w-100 form-control" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Region<span class="asterisk">*</span></p></span>
                                            <select id="edit_perp_d_region" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_perp_d_region', 'edit_perp_d_province', 'edit_perp_d_city', 'edit_perp_d_barangay')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="{{$editcaseformPerpet[0]->perp_d_region}}" selected>{{$editcaseformPerpet[0]->perp_d_region}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_perp_d_region_id" name="perp_d_region" value="{{$editcaseformPerpet[0]->perp_d_region}}"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Province<span class="asterisk">*</span></p></span>
                                            <select id="edit_perp_d_province" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_perp_d_region', 'edit_perp_d_province', 'edit_perp_d_city', 'edit_perp_d_barangay')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="{{$editcaseformPerpet[0]->perp_d_province}}" selected>{{$editcaseformPerpet[0]->perp_d_province}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_perp_d_province_id" name="perp_d_province" value="{{$editcaseformPerpet[0]->perp_d_province}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">City/Municipality<span class="asterisk">*</span></p></span>
                                            <select id="edit_perp_d_city" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_perp_d_region', 'edit_perp_d_province', 'edit_perp_d_city', 'edit_perp_d_barangay')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="{{$editcaseformPerpet[0]->perp_d_city}}" selected>{{$editcaseformPerpet[0]->perp_d_city}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_perp_d_city_id" name="perp_d_city" value="{{$editcaseformPerpet[0]->perp_d_city}}"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Barangay<span class="asterisk">*</span></p></span>
                                            <select id="edit_perp_d_barangay" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeAddressOnEditCase('edit_perp_d_region', 'edit_perp_d_province', 'edit_perp_d_city', 'edit_perp_d_barangay')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="{{$editcaseformPerpet[0]->perp_d_barangay}}" selected>{{$editcaseformPerpet[0]->perp_d_barangay}}</option>
                                                {{-- Drop-down list on this field are manipulated on "public/js/scripts.js" file --}}
                                            </select>
                                            <input type="hidden" id="edit_perp_d_barangay_id" name="perp_d_barangay" value="{{$editcaseformPerpet[0]->perp_d_barangay}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Current Location<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" name="perp_d_curr_loc" value="{{$editcaseformPerpet[0]->perp_d_curr_loc}}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div>
                                                <div class="form-check">
                                                    <input class="form-check-input perp_d_is_perp_minor" type="radio" name="perp_d_is_perp_minor" id="perp_d_is_pm_yes_radio" value="Yes" {{($editcaseformPerpet[0]->perp_d_is_perp_minor === 'Yes') ? 'Checked' : ''}} {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}/>
                                                    <label class="form-check-label" for="perp_d_is_pm_yes_radio">Yes</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input perp_d_is_perp_minor" type="radio" name="perp_d_is_perp_minor" id="perp_d_is_pm_no" value="No" {{($editcaseformPerpet[0]->perp_d_is_perp_minor === 'No') ? 'Checked' : ''}} {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}/>
                                                    <label class="form-check-label" for="perp_d_is_pm_no">No</label>
                                                </div>
                                                @if($cases_details[0]->form_status == 'Submitted')
                                                <input type="hidden" name="perp_d_is_perp_minor" value="{{$editcaseformPerpet[0]->perp_d_is_perp_minor}}" />
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <span><p class="card-text">If Yes, please indicate the name of parent/guardian:</p></span>
                                            <input type="text" value="{{$editcaseformPerpet[0]->perp_d_if_yes_pls_ind }}" class="w-100 form-control" name="perp_d_if_yes_pls_ind" id="perp_d_if_yes_pls_ind" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Address of parent/guardian:<span class="asterisk">*</span></p></span>
                                            <input type="text" value="{{$editcaseformPerpet[0]->perp_d_addr_par_gua }}" class="w-100 form-control" name="perp_d_addr_par_gua" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-md-5">
                                            <span><p class="card-text">Contact number of parent/guardian:<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" value="{{$editcaseformPerpet[0]->perp_d_cont_par_gua }}" name="perp_d_cont_par_gua" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Relationship of guardian to Perpetrator:<span class="asterisk">*</span></p></span>
                                            <select id="garrelvicsur" name="perp_d_rel_guar_perp" aria-aria-controls='example' class="date-picker w-100 form-control" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                <option value="">Please Select</option>
                                                <option value="Father" {{($editcaseformPerpet[0]->perp_d_rel_guar_perp === 'Father') ? 'Selected' : ''}}>Father</option>
                                                <option value="Mother" {{($editcaseformPerpet[0]->perp_d_rel_guar_perp === 'Mother') ? 'Selected' : ''}}>Mother</option>
                                                <option value="Others" {{($editcaseformPerpet[0]->perp_d_rel_guar_perp === 'Others') ? 'Selected' : ''}}>Others</option>
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" name="perp_d_rel_guar_perp" value="{{$editcaseformPerpet[0]->perp_d_rel_guar_perp}}" />
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Others, please specify:</p></span>
                                            <input type="text" class="w-100 form-control garrelVicsur" value="{{$editcaseformPerpet[0]->perp_d_rel_rgp_pls_spec }}" id="garinputrelvicsur" name="perp_d_rel_rgp_pls_spec" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-3"><p class="card-text">Other Information about the Perpetrator:</p></div>
                                        <div class="col-md-9 form-floating">
                                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="perp_d_oth_info_perp" rows="6" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}>{{$editcaseformPerpet[0]->perp_d_oth_info_perp }}</textarea>
                                        </div>
                                    </div>
                                    @if($master_list_rights_add == true)
                                            ...
                                            <tbody id="perp_det_table_tbody">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        @if(($master_list_rights_delete == true) && ($editcaseformCaseMod[0]->cm_case_status != 'Closed'))
                                                        <a href="javascript:void(0)" class="text-orange-icon" onclick="deleteSpecificAdditionalPerpetratorDetailsModal({{ $perpetrator_detail_info->id }})"><i class="fa fa-trash"></i></a>
                                                        @endif
                                                    </td>
                                ...
                                <div class="card-body">
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <select id="edit_im_type_of_service" name="im_type_of_service" aria-aria-controls='example' class="date-picker w-100 form-control typeofservice" onclick="changeTypeOfServiceAndSpecificInterventions('edit_im_type_of_service', 'edit_im_speci_interv')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                @if($editcaseformInter[0]->im_type_of_service == null)
                                                <option value="">Please Select</option>
                                                @else
                                                <option value="{{$editcaseformInter[0]->im_type_of_service}}" selected>{{$editcaseformInter[0]->im_type_of_service}}</option>
                                                @endif
                                                {{-- Drop-down list on this select option is in the "public/js/scripts.js" file --}}
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" class="w-100 form-control" name="im_type_of_service" id="im_type_of_service_id" value="{{$editcaseformInter[0]->im_type_of_service}}"/>
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Others, please specify:</p></span>
                                            <input type="text" class="w-100 form-control typeofService" name="im_typ_serv_if_oth_spec" id="inputtypeofService" value="{{$editcaseformInter[0]->im_typ_serv_if_oth_spec}}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Specific Interventions: (Select Type of Service first)<span class="asterisk">*</span></p></span>
                                            <select id="edit_im_speci_interv" name="im_speci_interv" aria-aria-controls='example' class="date-picker w-100 form-control speInt" onclick="changeTypeOfServiceAndSpecificInterventions('edit_im_type_of_service', 'edit_im_speci_interv')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                @if($editcaseformInter[0]->im_speci_interv == null)
                                                <option value="">Please Select</option>
                                                @else
                                                <option value="{{$editcaseformInter[0]->im_speci_interv}}" selected>{{$editcaseformInter[0]->im_speci_interv}}</option>
                                                @endif
                                                {{-- Drop-down list on this select option is in the "public/js/scripts.js" file --}}
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" class="w-100 form-control" name="im_speci_interv" id="im_speci_interv_id" value="{{$editcaseformInter[0]->im_speci_interv}}"/>
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Others, please specify:</p></span>
                                            <input type="text" class="w-100 form-control speInts" name="im_spe_int_if_oth_spec" id="inputspeInt" value="{{$editcaseformInter[0]->im_spe_int_if_oth_spec}}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Service Provider:<span class="asterisk">*</span></p></span>
                                            <select id="serviceprovider" name="im_serv_prov" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeServiceProvider('serviceprovider')" {{ (($cases_details[0]->form_status == 'Submitted') ? 'disabled' : '') }}>
                                                ...
                                                <option value="Others">Others</option>
                                                @else
                                                <option value="{{ $editcaseformInter[0]->im_serv_prov }}" selected>{{ $editcaseformInter[0]->im_serv_prov }}</option>
                                                @endif
                                            </select>
                                            @if($cases_details[0]->form_status == 'Submitted')
                                            <input type="hidden" class="w-100 form-control" name="im_serv_prov" id="im_serv_prov_id" value="{{$editcaseformInter[0]->im_serv_prov}}"/>
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Others, please specify:</p></span>
                                            <input type="text" id="inputserviceprovider" class="w-100 form-control serviceproviders" name="im_ser_pro_if_oth_spec" value="{{$editcaseformInter[0]->im_ser_pro_if_oth_spec}}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Specific Objective<span class="asterisk">*</span></p></span>
                                            <textarea type="text" class="w-100 form-control" name="im_speci_obje" rows="4" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}>{{$editcaseformInter[0]->im_speci_obje}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Target Date<span class="asterisk">*</span></p></span>
                                            <input type="date" class="w-100 form-control" name="im_target_date" value="{{$editcaseformInter[0]->im_target_date}}" {{ (($cases_details[0]->form_status == 'Submitted') ? 'readonly' : '') }}/>
                                        </div>
                                        <div class="col">
                                            ...
                                            <select name="im_status" aria-aria-controls='example' class="date-picker w-100 form-control">
                                                <option value="">Please Select</option>
                                                <option value="Provided" {{($editcaseformInter[0]->im_status === 'Provided') ? 'Selected' : ''}}>Provided</option>
                                                <option value="Not Provided" {{($editcaseformInter[0]->im_status === 'Not Provided') ? 'Selected' : ''}}>Not Provided</option>
                                                <option value="Ongoing" {{($editcaseformInter[0]->im_status === 'Ongoing') ? 'Selected' : ''}}>Ongoing</option>
                                            </select>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">If Status is Provided, Provide Date:</p></span>
                                            <input type="date" class="w-100 form-control" name="im_if_status_com_pd" value="{{$editcaseformInter[0]->im_if_status_com_pd}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <input id="im_dsp_full_name" name="im_dsp_full_name" class="w-100 form-control" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)"/>
                                            @else
                                            <select id="im_dsp_full_name" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)">
                                                <option value="{{$editcaseformInter[0]->im_dsp_full_name}}" selected>{{$editcaseformInter[0]->im_dsp_full_name}}</option>
                                            </select>
                                            <input type="hidden" class="w-100 form-control" name="im_dsp_full_name" id="im_dsp_full_name_id" value="{{$editcaseformInter[0]->im_dsp_full_name}}"/>
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Position/Designation<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" name="im_dsp_post_desi" id="im_dsp_post_desi" value="{{$editcaseformInter[0]->im_dsp_post_desi}}" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Email<span class="asterisk">*</span></p></span>
                                            <input type="email" class="w-100 form-control" name="im_dsp_email" id="im_dsp_email" value="{{$editcaseformInter[0]->im_dsp_email}}" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">1st Contact No. (Mobile)<span class="asterisk">*</span></p></span>
                                            <input type="text" class="w-100 form-control" name="im_dsp_contact_no_1" id="im_dsp_contact_no_1" value="{{$editcaseformInter[0]->im_dsp_contact_no_1}}" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">2nd Contact No. (Mobile)</p></span>
                                            <input type="text" class="w-100 form-control" name="im_dsp_contact_no_2" id="im_dsp_contact_no_2" value="{{$editcaseformInter[0]->im_dsp_contact_no_2}}" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">3rd Contact No. (Landline)</p></span>
                                            <input type="text" class="w-100 form-control" name="im_dsp_contact_no_3" id="im_dsp_contact_no_3" value="{{$editcaseformInter[0]->im_dsp_contact_no_3}}" onclick="changeDirectories(`serviceprovider`, `im_dsp_full_name`, `im_dsp_post_desi`, `im_dsp_email`, `im_dsp_contact_no_1`, `im_dsp_contact_no_2`, `im_dsp_contact_no_3`)"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <input id="im_dasp_full_name" name="im_dasp_full_name" class="w-100 form-control" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)"/>
                                            @else
                                            <select id="im_dasp_full_name" aria-aria-controls='example' class="date-picker w-100 form-control" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)">
                                                <option value="{{$editcaseformInter[0]->im_dasp_full_name}}" selected>{{$editcaseformInter[0]->im_dasp_full_name}}</option>
                                            </select>
                                            <input type="hidden" class="w-100 form-control" name="im_dasp_full_name" id="im_dasp_full_name_id" value="{{$editcaseformInter[0]->im_dasp_full_name}}"/>
                                            @endif
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Position/Designation</p></span>
                                            <input type="text" class="w-100 form-control" name="im_dasp_post_desi" id="im_dasp_post_desi" value="{{$editcaseformInter[0]->im_dasp_post_desi}}" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Email</p></span>
                                            <input type="email" class="w-100 form-control" name="im_dasp_email" id="im_dasp_email" value="{{$editcaseformInter[0]->im_dasp_email}}" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">1st Contact No. (Mobile)</p></span>
                                            <input type="text" class="w-100 form-control" name="im_dasp_contact_no_1" id="im_dasp_contact_no_1" value="{{$editcaseformInter[0]->im_dasp_contact_no_1}}" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">2nd Contact No. (Mobile)</p></span>
                                            <input type="text" class="w-100 form-control" name="im_dasp_contact_no_2" id="im_dasp_contact_no_2" value="{{$editcaseformInter[0]->im_dasp_contact_no_2}}" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">3rd Contact No. (Landline)</p></span>
                                            <input type="text" class="w-100 form-control" name="im_dasp_contact_no_3" id="im_dasp_contact_no_3" value="{{$editcaseformInter[0]->im_dasp_contact_no_3}}" onclick="changeDirectories(`serviceprovider`, `im_dasp_full_name`, `im_dasp_post_desi`, `im_dasp_email`, `im_dasp_contact_no_1`, `im_dasp_contact_no_2`, `im_dasp_contact_no_3`)"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                        ...
                                        <table class="table table-hover no-footer">
                                            ...
                                            <tbody id="inter_mod_table_tbody">
                                                ...
                                                <tr>
                                                    <td>
                                                        @if(($master_list_rights_revise == true) && ($editcaseformCaseMod[0]->cm_case_status != 'Closed'))
                                                        <a href="javascript:void(0)" class="text-orange-icon" data-bs-toggle="modal" data-bs-target="#modalInterventionModuleInfos" onclick="getSpecificAdditionalInterventionModuleForm({{ $intervention_module_info->id }}, `Edit`)"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        ...
                                                        @if(($master_list_rights_delete == true) && ($editcaseformCaseMod[0]->cm_case_status != 'Closed'))
                                                        <a href="javascript:void(0)" class="text-orange-icon" onclick="deleteSpecificAdditionalInterventionModuleModal({{ $intervention_module_info->id }})"><i class="fa fa-trash"></i></a>
                                                        @endif
                                                    </td>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <div>
                                                <div class="form-check">
                                                    <input class="form-check-input rm_was_cli_ref_by_org" type="radio" name="rm_was_cli_ref_by_org" id="rm_was_cli_ref_org_yes_radio" value="Yes" {{($editcaseformRefer[0]->rm_was_cli_ref_by_org === 'Yes') ? 'Checked' : ''}}/>
                                                    <label class="form-check-label" for="rm_was_cli_ref_org_yes_radio">Yes</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input rm_was_cli_ref_by_org" type="radio" name="rm_was_cli_ref_by_org" id="rm_was_cli_ref_org_no_radio" value="No" {{($editcaseformRefer[0]->rm_was_cli_ref_by_org === 'No') ? 'Checked' : ''}}/>
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <input type="text" class="w-100 form-control" name="rm_name_ref_org" id="rm_name_ref_org" value="{{$editcaseformRefer[0]->rm_name_ref_org}}"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Referral/Case No. from the referring organization:</p></span>
                                            <input type="text" class="w-100 form-control" name="rm_ref_fro_ref_org" id="rm_ref_fro_ref_org" value="{{$editcaseformRefer[0]->rm_ref_fro_ref_org}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Address of Referring organization:</p></span>
                                            <input type="text" class="w-100 form-control" name="rm_addr_ref_org" id="rm_addr_ref_org" value="{{$editcaseformRefer[0]->rm_addr_ref_org}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Referred by:</p></span>
                                            <input type="text" class="w-100 form-control" name="rm_referred_by" id="rm_referred_by" value="{{$editcaseformRefer[0]->rm_referred_by}}"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Position title:</p></span>
                                            <input type="text" class="w-100 form-control" name="rm_position_title" id="rm_position_title" value="{{$editcaseformRefer[0]->rm_position_title}}"/>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <span><p class="card-text">Contact No.:</p></span>
                                            <input type="text" class="w-100 form-control" name="rm_contact_no" id="rm_contact_no" value="{{$editcaseformRefer[0]->rm_contact_no}}"/>
                                        </div>
                                        <div class="col">
                                            <span><p class="card-text">Email Address:</p></span>
                                            <input type="email" class="w-100 form-control" name="rm_email_add" id="rm_email_add" value="{{$editcaseformRefer[0]->rm_email_add}}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{-- CASE MODULE --}}
                        <fieldset>
                            <div class="card border-light shadow-lg">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <select name="cm_case_status" aria-aria-controls='example' class="date-picker text-box w-50 form-control" {{ (($master_list_rights_approved_disapproved == false) ? 'disabled' : '') }}>
                                                <option value="">Please Select</option>
                                                <option value="Ongoing" {{($editcaseformCaseMod[0]->cm_case_status === 'Ongoing') ? 'Selected' : ''}}>Ongoing</option>
                                                <option value="Completed" {{($editcaseformCaseMod[0]->cm_case_status === 'Completed') ? 'Selected' : ''}}>Completed</option>
                                                <option value="Closed" {{($editcaseformCaseMod[0]->cm_case_status === 'Closed') ? 'Selected' : ''}}>Closed</option>
                                            </select>
                                            @if($master_list_rights_approved_disapproved == false)
                                            <input type="hidden" name="cm_case_status" value="{{ $editcaseformCaseMod[0]->cm_case_status }}"/>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                                ...
                                                <table class="table table-hover no-footer">
                                                    ...
                                                    <tbody id="case_uploaded_files_table_data">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                @if(($master_list_rights_delete == true) && ($editcaseformCaseMod[0]->cm_case_status != 'Closed'))
                                                                <a href="javascript:void(0);" class="text-orange-icon" onclick="deleteCaseUploadedFilesModal('{{ $uploaded_files->id }}', `{{ $editcaseformPerso[0]->case_no }}`,`{{ $uploaded_files->file }}`)"><i class="fa fa-trash"></i></a>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                <a href="{{ env('APP_URL').$uploaded_files->file_location }}">{{ $uploaded_files->file ?? '-' }}</a>
                                                            </td>
                            ...
                            <input type="button" class="btn btn-danger btn-md px-5 mx-1 float-end" value="Submit" onclick="submitEditCaseForm('Submitted','{{ $editcaseformPerso[0]->case_no }}')"/>
                            @if($cases_details[0]->form_status == 'Draft')
                            <input type="button" class="btn btn-danger btn-md px-5 mx-1 float-end" value="Save as Draft" onclick="submitEditCaseForm('Draft','{{ $editcaseformPerso[0]->case_no }}')"/>
                            @endif
                        </fieldset>
