        ...
        <div class="card o-hidden border-0 shadow-lg my-2">
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 d-none d-lg-block bg-login-image bg-black" style="background-image: url('{{ asset('images/gbv_logos.png') }}'); background-size: contain; background-repeat: no-repeat;"></div>
                </div>
            </div>
        </div>
    </div>
