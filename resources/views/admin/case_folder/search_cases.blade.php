    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6" style="display: flex; align-items: center;">
            <h1 class="text-gray-800">Search Cases</h1>
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Search Cases</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card-body table-responsive">
        <form action="javascript:void(0);" id="search_case_no_or_last_name_form" onsubmit="searchCase()">
          <div class="input-group">
            <input type="text" name="case_no_or_last_name_search" id="case_no_or_last_name_search" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" value="{{ $query_input }}">
